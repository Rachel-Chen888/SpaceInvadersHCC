...
#     else:
#         enemy.shape('enemy1.gif')  # if it is a normal alien, make it false
...
# def collision(obj1: turtle.Turtle,
#               obj2: turtle.Turtle) -> bool:  # objs being alien and bullet(both turtles), and it returns a boolean
